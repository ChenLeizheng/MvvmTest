...
import com.landleaf.everyday.utils.ViewUtil;
...
public class LandleafView extends View {
    ...
    protected float startNum = 0;//初始值
    ...
    protected void initAttrs(Context context, AttributeSet attrs) {
        ...
        cStartAngle = ta.getDimensionPixelOffset(R.styleable.LandleafView_cStartAngle, 120);
        ...
        strUnitSize = ta.getInteger(R.styleable.LandleafView_strUnitSize, 30);
...
//        LLog.d(TAG, "绘制弧形!!!");
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width;
        int height;
        int defaultWidth = (int) (getPaddingLeft() + mCenter * 2 + getPaddingRight());
        Log.d("RulerView", "AT_MOST:" + (widthMode == MeasureSpec.AT_MOST)+",EXACTLY:" + (widthMode == MeasureSpec.EXACTLY));
...
//        Log.d(TAG, "ShiftLen:" + shiftLen);
        ...
        float strHeight = ViewUtil.getStringHeight(txtPaint);
        float strWidth = ViewUtil.getStringWidth(levelText, txtPaint);
...
//        LLog.d(TAG, "点1：(" + x1 + "," + y1 + "),点2：(" + x2 + "," + y2 + "),点3：(" + x3 + "," + y3 + ")");
    ...
    protected void runTextAnimator(final float number) {
        int duration = 1000;
