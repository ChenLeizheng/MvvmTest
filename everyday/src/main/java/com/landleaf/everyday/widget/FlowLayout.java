        ...
        for (int i=0; i<count;i++){
            ...
            if (childWidth > r-l){
                if (child instanceof TextView){
                    ...
                    int parentWidth = r-l-lp.leftMargin-lp.rightMargin-child.getPaddingLeft()-child.getPaddingRight();
                    int textWidth = childWidth-lp.leftMargin-lp.rightMargin-child.getPaddingLeft()-child.getPaddingRight();
                    int showLength = length*parentWidth/textWidth -1;
                    text = text.substring(0,showLength)+"...";
                    tv.setText(text);
                    tv.setWidth(parentWidth);
                    Log.d("FlowLayout", "parentWidth:" + parentWidth+","+textWidth+",childWidth,"+childWidth+",showLength"+showLength);
                }
            }
