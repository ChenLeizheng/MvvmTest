...
public class Server {
    ...
    public static Builder newBuilder(String group) {
            ...
            public void run() {
                ...
                mHttpServer = ServerBootstrap.bootstrap()
                    .setSocketConfig(SocketConfig.custom()
                        ...
                        .build())
                    .setConnectionConfig(
                        ConnectionConfig.custom().setBufferSize(4 * 1024).setCharset(Charset.forName("UTF-8")).build())
    ...
    private final class SSLInitializerWrapper implements SSLServerSetupHandler {
        ...
        public SSLInitializerWrapper(SSLInitializer initializer) {
